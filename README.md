# **_Projecte Intermodular WIFI SALUT_**

Exemple de repositori Github per al projecte Intermodular de 2n SMX - WIFI SALUT

## Estructura del repositori del projecte WIFI SALUT
